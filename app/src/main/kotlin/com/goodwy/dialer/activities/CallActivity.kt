...
class CallActivity : SimpleActivity() {
    ...
    private fun initButtons() {
        ...
        dialpad_include.setBackgroundColor(config.backgroundColor)
    ...
    private fun initProximitySensor() {
        if (!config.disableProximitySensor && (proximityWakeLock == null || proximityWakeLock?.isHeld == false)) {
            ...
            proximityWakeLock = powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "com.goodwy.dialer.pro:wake_lock")
